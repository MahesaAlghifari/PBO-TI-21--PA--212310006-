package com.ibik.pbo.praktikum.PBO_NPM_PRAKTIKUM_7;
...
public class Latihan3 extends JFrame {
    ...
    private void GenerateUI(Latihan3 frame) {
        ...
        ActionListener actionSubmit = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String myEmail = "212310006@student.ibik.ac.id";
                String myName = "Mahesa Alghifari";
                String myPass = "212310006";
